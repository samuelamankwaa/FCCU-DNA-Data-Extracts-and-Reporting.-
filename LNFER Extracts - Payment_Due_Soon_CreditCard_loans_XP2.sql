------- LNFER Extracts - Payment_Due_Soon_CreditCard_loans
-----------------------------------------------------------------------
-----------------------------------------------------------------------
-- XP2

DECLARE @DL_Load_Date datetime = '2024-01-28';
...
where  
	...
	and l.loan_type in (49,51,52,53,54,57,58,55,56)
	...
	and l.balance > 0
	and DATEDIFF(d,getdate(),l.next_due_date) = 5
